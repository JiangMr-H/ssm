	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					数据列表<small>数据员审核</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li>
					<li><a href="#">报废管理</a></li>
					<li class="active">数据员审核</li>
				</ol>
			</section>
			<!-- 内容头部 /-->
									...
									<tr>
										...
										<td class="text-center">
											<a type="button" class="btn bg-olive btn-xs" data-toggle="modal"
											   data-target="#exampleModal" onclick="location.href='${pageContext.request.contextPath}/scrap/findByJSYId.do?id=${scrap.id }'">
												审批
											</a>
			...
			<%--<form action="#"
				...
				<section class="content"> <!--产品信息-->
					...
					<div class="panel panel-default">
						<div class="panel-heading">数据员审核</div>
