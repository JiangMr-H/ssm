	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					数据列表<small>工艺确认</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li>
					<li><a href="#">无纸化点检</a></li>
					<li class="active">工艺确认</li>
				</ol>
			</section>
			<!-- 内容头部 /-->
										...
										<td class="text-center">
												...
												<%--  <button type="button" class="btn bg-olive btn-xs"
													...
													<a type="button" class="btn bg-olive btn-xs" data-toggle="modal"
													   data-target="#exampleModal" onclick="location.href='${pageContext.request.contextPath}/GYCS/findByGYId.do?id=${gycs.id }'">
														审批
													</a>
			...
			<%--<form action="#"
				...
				<section class="content"> <!--产品信息-->
					...
					<div class="panel panel-default">
						<div class="panel-heading">工艺确认</div>
