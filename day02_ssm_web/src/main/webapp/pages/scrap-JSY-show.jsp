	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					数据列表<small>接收员确认</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li>
					<li><a href="#">报废管理</a></li>
					<li class="active">接收员确认</li>
				</ol>
			</section>
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="modal-dialog modal-lg  with-border" style="width: 1700px"  role="document">
							<div class="modal-content">
								...
								<form action="${pageContext.request.contextPath}/scrap/updateJSY.do?id=${TSYscrap.id}"
									  method="post">
								...
								<div class="modal-body modal-lg" style="width: 1800px">
									...
									<section class="content"> <!--产品信息-->
										...
										<div class="panel panel-default">
											<div class="panel-heading">接收员确认</div>
											<div class="row data-type">

												<div class="col-md-2 title">角色名称</div>
												<div class="col-md-4 data">
													<input type="text" class="form-control" name="RoleName_JSY"
														   placeholder="角色名称" value="">
												</div>
												<div class="col-md-2 title">角色描述</div>
												<div class="col-md-4 data">
													<input type="text" class="form-control" name="RoleDescription_JSY"
