				...
				<div class="box box-primary">
					...
					<div class="modal-dialog modal-lg  with-border" style="width: 1700px"  role="document">
							<div class="modal-content">
								...
								<form action="${pageContext.request.contextPath}/scrap/updateZLJS.do?id=${TSYscrap.id}"
									  method="post">
								...
								<div class="modal-body modal-lg" style="width: 1800px">
									...
									<section class="content"> <!--产品信息-->
										...
										<div class="panel panel-default">
											<div class="panel-heading">质量科长审核</div>
											<div class="row data-type">

												<div class="col-md-2 title">角色名称</div>
												<div class="col-md-4 data">
													<input type="text" class="form-control" name="RoleName_ZLJS"
														   placeholder="角色名称" value="">
												</div>
												<div class="col-md-2 title">角色描述</div>
												<div class="col-md-4 data">
													<input type="text" class="form-control" name="RoleDescription_ZLJS"
